...
/* Memory mapping of Core Hardware */
REG_2_RAM SCS_BASE       ;                    /*!< System Control Space Base Address */
REG_2_RAM ITM_BASE       ;                    /*!< ITM Base Address */
REG_2_RAM DWT_BASE       ;                    /*!< DWT Base Address */
REG_2_RAM TPI_BASE       ;                    /*!< TPI Base Address */
REG_2_RAM CoreDebug_BASE ;                    /*!< Core Debug Base Address */
REG_2_RAM SysTick_BASE   ;                    /*!< SysTick Base Address */
REG_2_RAM NVIC_BASE      ;                    /*!< NVIC Base Address */
REG_2_RAM SCB_BASE       ;                    /*!< System Control Block Base Address */
...
#if defined (__MPU_PRESENT) && (__MPU_PRESENT == 1U)
  REG_2_RAM MPU_BASE     ;                             /*!< Memory Protection Unit */
  #define MPU               ((MPU_Type       *)     &MPU_BASE      )   /*!< Memory Protection Unit */
#endif

REG_2_RAM FPU_BASE       ;                        /*!< Floating Point Unit */
#define FPU                 ((FPU_Type       *)     &FPU_BASE      )   /*!< Floating Point Unit */
